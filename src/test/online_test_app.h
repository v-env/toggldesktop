...
private:
    ...
    void on_display_idle_notification(const std::string &guid, const std::string &since, const std::string &duration, uint64_t started, const std::string &description);
